...
//
//   P13 Step 0: Graph Setup            — build operator graph with tensor shapes
//   P13 Step 1: Liveness Analysis      — compute live intervals [first_use, last_use] per tensor
//   P13 Step 2: Interference Graph     — build conflict graph (overlapping lifetimes)
//   P13 Step 3: Greedy Offset Planning — assign offsets using best-fit-decreasing
//   P13 Step 4: Buffer Reuse           — share memory between non-overlapping tensors
//   P13 Step 5: In-place Optimization  — eliminate copies by aliasing input/output buffers
//   P13 Step 6: Summary                — peak memory, reuse ratio, fragmentation
//
...
// =====================================================================
// P13 Step 3: Greedy Offset Planning (Best-Fit Decreasing)
// =====================================================================
...
// =====================================================================
// P13 Step 4: Buffer Reuse Analysis
// =====================================================================
...
// =====================================================================
// P13 Step 5: In-place Optimization
// =====================================================================
...
// =====================================================================
// P13 Step 7: KVCache-aware Decode Memory Planning
// =====================================================================
