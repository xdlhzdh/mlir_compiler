...
//
//   P12 Step 0: Graph Setup         — build a small Conv+BN+ReLU+MatMul inference graph
//   P12 Step 1: Calibration         — collect min/max/histogram per tensor (simulated)
//   P12 Step 2: Scale Computation   — compute per-tensor/per-channel scale + zero_point
//   P12 Step 3: Operator Fusion     — fuse patterns for quantized execution (Conv+BN+ReLU → QConv)
//   P12 Step 4: Graph Rewrite       — insert quantize/dequantize ops, lower to int8 compute
//   P12 Step 5: Mixed Precision     — decide FP16 vs INT8 per operator (sensitivity analysis)
//   P12 Step 6: Summary & Speedup   — compare model size, estimated throughput
//
...
// =====================================================================
// P12 Step 3: Operator Fusion for Quantization
// =====================================================================
...
// =====================================================================
// P12 Step 4: Graph Rewrite — Insert Q/DQ ops
// =====================================================================
...
// =====================================================================
// P12 Step 4b: Rewrite imported ONNX QDQ → qlinear ops
// =====================================================================
...
// =====================================================================
// P12 Step 5: Mixed Precision — sensitivity analysis
// =====================================================================
...
// =====================================================================
// P12 Step 6: Summary & Speedup Estimate
// =====================================================================
