...
//
//   P11 Step 0: Parallel Detection   — identify parallelizable ops (linalg.generic, scf.parallel)
//   P11 Step 1: Thread Mapping       — map parallel dims → GPU grid/block (blockIdx/threadIdx)
//   P11 Step 2: GPU Dialect Emission — emit gpu.launch_func, gpu.block_id, gpu.thread_id
//   P11 Step 3: Shared Memory Tiling — insert shared memory allocation + tiled loads + barriers
//   P11 Step 4: NVVM Lowering        — gpu dialect → NVVM (tid/ctaid/barrier0, LLVM pointer ops)
//   P11 Step 5: PTX Emission         — NVVM → PTX assembly text
//   P11 Step 6: Occupancy Analysis   — estimate register/smem usage, compute SM occupancy
//
...
// =====================================================================
// P11 Step 2: GPU Dialect Emission
// =====================================================================
...
// =====================================================================
// P11 Step 3: Shared Memory Tiling Analysis
// =====================================================================
