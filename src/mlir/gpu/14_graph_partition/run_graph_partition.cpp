// run_graph_partition.cpp — Graph Partitioning teaching pipeline (P14).
//
...
//
//   P14 Step 0: Build layer graph (Attention + Residual + LN + FFN + Residual)
//   P14 Step 1: Annotate ops with partition hints
//   P14 Step 2: Cut at residual/LN boundaries → two partitions
//   P14 Step 3: Compute boundary tensors + estimated comm volume
//   P14 Step 4: Summary (partition sizes, comm bytes, interview talking points)
//
...
int main() {
  std::cout << "====================================================\n"
            << " P14: Graph Partitioning (Transformer Layer Cut)\n"
            << "====================================================\n";
