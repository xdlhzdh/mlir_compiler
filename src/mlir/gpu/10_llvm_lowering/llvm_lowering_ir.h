#pragma once
// llvm_lowering_ir.h — P10 (10_llvm_lowering): multi-level IR for Vector → machine code.
//
...
// ======================== Machine Instruction (P10 Step 3) ========================
...
// ======================== Register Allocation (P10 Step 4) ========================
